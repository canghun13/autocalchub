...
2. **병목은 도메인 권위 + 크롤링 예산.** 해결 수단은 콘텐츠 볼륨이 아니라 (a) 외부 백링크, (b) 시간, (c) 색인 안 되는 개별 페이지의 내부링크 구조 점검. **(사용자 방침: 발행 속도 자체를 줄이자는 결론은 내지 말 것 — 8/7 세션에서 명시적으로 기각됨, 공격적 확장 기조 유지가 기본값. 아래 6-12 참고.)**
